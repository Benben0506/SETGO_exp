...
class LitUnsupervisedSegmenter(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        print('train_cluster_loss', cluster_loss)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            print('val_cluster_loss', cluster_loss)
...
@hydra.main(config_path="configs", config_name="train_config_1.yml")
def my_app(cfg: DictConfig) -> None:
    ...
    print('Hello2')
    trainer.save_checkpoint("./outputs/base_corp5_3000.ckpt")
