...
class TrainingExperiment:
    ...
    def submit(self, registered_dataset):
        ...
        gpu_run_config = RunConfiguration(script="val_stego.py")
        ...
        output_dataset = OutputFileDatasetConfig(name="val_stego", source="/mnt/data/output_dataset/")

        val_STEGO = PythonScriptStep(
            name="Val_stego",
            script_name="val_stego.py",
            source_directory=".",
        ...
        pipeline = Pipeline(workspace=self._workspace, steps=[val_STEGO])
        pipeline.validate()
        return pipeline
